"use client";
import { updateCategory } from "@/lib/server-actions/categoryActions";
...
export default function EditCategory({ category }) {
    ...
    async function handleUpdate(event) {
        ...
        const { message, targetUrl } = await updateCategory({ message: null, targetUrl: null }, data);
    ...
    return (
        <form ref={formRef} className='form' onSubmit={handleUpdate}>
            ...
            <div className='normalInput'>
                ...
                <AutoResizeTextArea name={"categoryDescription"} required={true}
                    placeholder={"Enter a short description of the category"} defaultValue={category?.categoryDescription}
                />
            </div>
